...
__s32 BSP_disp_set_output_csc(__u32 sel, __disp_out_csc_type_t out_type)
{
        ...
        b_hdcp = gdisp.screen[sel].hdmi_hdcp_en;
	...
	else if(out_type == DISP_OUT_CSC_TYPE_LCD)
	{
        ...
        DE_BE_Set_Enhance_ex(sel, gdisp.screen[sel].out_csc, gdisp.screen[sel].out_color_range, enhance_en, bright, contrast, saturation, hue, b_hdcp);
