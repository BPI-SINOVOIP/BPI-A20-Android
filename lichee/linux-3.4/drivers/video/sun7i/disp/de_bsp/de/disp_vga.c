...
__s32 Disp_VGA_Init(__u32 sel)
{		
    if(gdisp.init_para.boot_output_type == DISP_OUTPUT_TYPE_VGA
            && gdisp.init_para.boot_output_channel == sel)
    {
        gdisp.screen[sel].vga_mode = gdisp.init_para.boot_output_mode;
        gdisp.screen[1 - sel].vga_mode = DISP_VGA_H1024_V768;
