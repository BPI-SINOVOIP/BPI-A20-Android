...
__s32 BSP_disp_init(__disp_bsp_init_para * para)
{
    ...
    if(gdisp.init_para.boot_output_type != DISP_OUTPUT_TYPE_LCD || gdisp.init_para.boot_output_channel != 0)
        BSP_disp_close_lcd_backlight(0);
    if(gdisp.init_para.boot_output_type != DISP_OUTPUT_TYPE_LCD || gdisp.init_para.boot_output_channel != 1)
    ...
    disp_video_init();
	 ...
	 gdisp.init_para.boot_output_type = 0;
     gdisp.init_para.boot_output_mode = 0;
     gdisp.init_para.boot_output_channel = 0xff;
