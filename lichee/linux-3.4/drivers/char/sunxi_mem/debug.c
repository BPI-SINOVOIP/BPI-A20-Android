...
static int sunmm_stats_show(struct seq_file *m, void *unused)
{
	...
	seq_printf(m, "sunxi memory: total:%dM, free:%dM, largest free block %dM\n", (reserved_addr.size >> 20), rest_total, largest_size);
	return 0;
}
