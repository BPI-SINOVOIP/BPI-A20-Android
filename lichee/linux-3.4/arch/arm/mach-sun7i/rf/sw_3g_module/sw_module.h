...
#define SW_DRIVER_NAME          "SoftWinner modem Module"
...
struct sw_modem{
    ...
    struct sw_module_pio modem_vbat;
    struct sw_module_pio modem_pwr_on;
    struct sw_module_pio modem_rst;
    struct sw_module_pio modem_rf_dis;
    struct sw_module_pio modem_wake;
    struct sw_module_pio modem_wake_ap;
