...
#define AW_IRQ_PMU0       	(AW_IRQ_GIC_START + 120) /* 152 */
#define AW_IRQ_PMU1       	(AW_IRQ_GIC_START + 121) /* 153 */
#define AW_IRQ_PMU2       	(AW_IRQ_GIC_START + 122) /* 154 */
#define AW_IRQ_PMU3       	(AW_IRQ_GIC_START + 123) /* 155 */
