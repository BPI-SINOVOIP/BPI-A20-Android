...
int display_product_info()
{
    ...
    sleep(1);
    if(!readline()){
        db_error("2gtester:no correct response for the ATI\n");
        return 0;
    }
    db_msg("2gtester ATI readline: %s\n",s_ATBuffer);
