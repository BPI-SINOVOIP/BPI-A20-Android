...
LICHEE_ROOT=$PWD
LICHEE_OUT_DIR=$LICHEE_ROOT/out
PACK_ROOT=""
TARGET_CHIP="sun4i"
...
selct_boot()
{
	...
	PACK_ROOT=`sed -n '/PACK_ROOT=/'p ${LICHEE_OUT_DIR}/pack_root.cfg | sed 's/PACK_ROOT=//'`

	if [ "${PACK_ROOT}" = "tools/pack_v1.0" ]; then
		echo -e "\033[0;31;1m###################\033[0m"
		echo -e "\033[0;31;1m#   use boot1.0   #\033[0m"
		echo -e "\033[0;31;1m###################\033[0m"
	elif [ "${PACK_ROOT}" = "tools/pack_brandy" ]; then
		echo -e "\033[0;31;1m###################\033[0m"
