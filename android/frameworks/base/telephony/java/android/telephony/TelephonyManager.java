...
public class TelephonyManager {
	...
	if (imei != null)
	    ...
	    Random r = new Random();
	    imei = "35";
	    for (int i = 0; i < (IMEI_LEN - 2); i++) 
		imei += (Math.abs(r.nextInt()) % 10);
	}
        Log.d(TAG, "IMEI: " + imei);
	return imei;
    }
    ...
    public int getCurrentPhoneType() {
        try{
            ...
            if (telephony != null) {
            	...
            	Log.e(TAG, "getCurrentPhoneType(), telephone service is null");
    ...
    public int getPhoneType() {
        if (!isVoiceCapable()) {
			Log.e(TAG, "getPhoneType(), VoiceCapable is false");
