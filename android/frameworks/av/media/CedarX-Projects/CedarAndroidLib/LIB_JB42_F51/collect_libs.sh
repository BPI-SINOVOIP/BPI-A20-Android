...
cp $SRCDIR0/libaw_stream_intermediates/libaw_stream.a ./
cp $SRCDIR0/libhttplive_intermediates/libhttplive.a ./

cp $SRCDIR0/libFaceDet_intermediates/libFaceDet.a ./
cp $SRCDIR0/libmemwatch_intermediates/libmemwatch.a ./
...
#cp $SRCDIR0/../../system/lib/libdemux_rmvb.so ./
#cp $SRCDIR0/../../system/lib/librm.so ./
