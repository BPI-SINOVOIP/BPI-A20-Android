...
LOCAL_C_INCLUDES:= \
    ...
    ${CEDARX_TOP}/stream/foundation/include
...
LOCAL_LDFLAGS += \
	...
	$(CEDARX_TOP)/../CedarAndroidLib/LIB_$(CEDARX_ANDROID_CODE)_$(CEDARX_CHIP_VERSION)/libaw_stream.a \
	$(CEDARX_TOP)/../CedarAndroidLib/LIB_$(CEDARX_ANDROID_CODE)_$(CEDARX_CHIP_VERSION)/libhttplive.a \
...
LOCAL_SHARED_LIBRARIES += libstagefright_foundation libstagefright libdrmframework libcrypto
