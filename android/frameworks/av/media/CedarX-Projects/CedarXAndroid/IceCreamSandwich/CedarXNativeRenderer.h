...
enum VIDEORENDER_CMD
{
	...
	//yuanlian 20140415, add keep last frame macro
#ifdef __CDX_ENABLE_KEEP_LAST_FRAME
    VIDEORENDER_CMD_IS_HWC             = 0x2000,
    VIDEORENDER_CMD_IS_LAST_FRAME_KEPT = 0x2001,
    VIDEORENDER_CMD_KEEP_LAST_FRAME    = 0x2002,
#endif
};
