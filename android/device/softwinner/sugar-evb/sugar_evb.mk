...
DEVICE_PACKAGE_OVERLAYS := device/softwinner/sugar-evb/overlay

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-evb/modules/modules/nand.ko:root/nand.ko \
	device/softwinner/sugar-evb/modules/modules/sun7i-ir.ko:root/sun7i-ir.ko \
	#device/softwinner/sugar-evb/modules/modules/disp.ko:root/disp.ko \
	#device/softwinner/sugar-evb/modules/modules/lcd.ko:root/lcd.ko \
	#device/softwinner/sugar-evb/modules/modules/hdmi.ko:root/hdmi.ko \

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-evb/kernel:kernel \
	device/softwinner/sugar-evb/recovery.fstab:recovery.fstab \

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-evb/ueventd.sun7i.rc:root/ueventd.sun7i.rc \
	device/softwinner/sugar-evb/init.sun7i.rc:root/init.sun7i.rc \
	device/softwinner/sugar-evb/init.sun7i.usb.rc:root/init.sun7i.usb.rc \
	device/softwinner/sugar-evb/init.recovery.sun7i.rc:root/init.recovery.sun7i.rc \
	device/softwinner/sugar-evb/needfix.rle:root/needfix.rle \
	device/softwinner/sugar-evb/camera.cfg:system/etc/camera.cfg \
	device/softwinner/sugar-evb/media_profiles.xml:system/etc/media_profiles.xml \
	frameworks/native/data/etc/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

#input device config
PRODUCT_COPY_FILES += \
	device/softwinner/sugar-evb/sw-keyboard.kl:system/usr/keylayout/sw-keyboard.kl \
	device/softwinner/sugar-evb/sun7i-ir.kl:system/usr/keylayout/sun7i-ir.kl \
	device/softwinner/sugar-evb/tp.idc:system/usr/idc/tp.idc \
	device/softwinner/sugar-evb/gsensor.cfg:system/usr/gsensor.cfg

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-evb/initlogo.rle:root/initlogo.rle

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-evb/vold.fstab:system/etc/vold.fstab
...
$(call inherit-product-if-exists, device/softwinner/sugar-evb/modules/modules.mk)

PRODUCT_CHARACTERISTICS := tablet

# Overrides
PRODUCT_BRAND  := softwinners
PRODUCT_NAME   := sugar_evb
PRODUCT_DEVICE := sugar-evb
