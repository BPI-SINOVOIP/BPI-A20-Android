...
TARGET_RECOVERY_UI_LIB := librecovery_ui_R1_Qbox
...
ifeq ($(BOARD_WIFI_VENDOR), realtek)
    ...
    SW_BOARD_USR_WIFI := rtl8821au
    BOARD_WLAN_DEVICE := rtl8821au
...
ifeq ($(BOARD_WIFI_VENDOR), broadcom)
    ...
    WIFI_DRIVER_MODULE_ARG      := "firmware_path=/system/vendor/modules/fw_bcm4339a0_ag.bin nvram_path=/system/vendor/modules/nvram_ap6335.txt iface_name=wlan0"
    #WIFI_DRIVER_MODULE_PATH     := "/system/vendor/modules/bcmdhd.ko"
