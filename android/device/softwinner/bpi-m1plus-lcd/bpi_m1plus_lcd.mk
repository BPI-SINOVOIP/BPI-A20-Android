...
DEVICE_PACKAGE_OVERLAYS := device/softwinner/bpi-m1plus-lcd/overlay

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-lcd/modules/modules/nand.ko:root/nand.ko \
	device/softwinner/bpi-m1plus-lcd/modules/modules/sun7i-ir.ko:root/sun7i-ir.ko 

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-lcd/kernel:kernel \
	device/softwinner/bpi-m1plus-lcd/recovery.fstab:recovery.fstab \
	frameworks/native/data/etc/android.hardware.wifi.xml:system/etc/permissions/android.hardware.wifi.xml \
	frameworks/base/data/etc/android.hardware.wifi.direct.xml:system/etc/permissions/android.hardware.wifi.direct.xml 

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-lcd/ueventd.sun7i.rc:root/ueventd.sun7i.rc \
	device/softwinner/bpi-m1plus-lcd/init.sun7i.rc:root/init.sun7i.rc \
	device/softwinner/bpi-m1plus-lcd/init.sun7i.usb.rc:root/init.sun7i.usb.rc \
	device/softwinner/bpi-m1plus-lcd/init.recovery.sun7i.rc:root/init.recovery.sun7i.rc \
	device/softwinner/bpi-m1plus-lcd/camera.cfg:system/etc/camera.cfg \
	device/softwinner/bpi-m1plus-lcd/media_profiles.xml:system/etc/media_profiles.xml \
	frameworks/native/data/etc/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml \
        frameworks/native/data/etc/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml

#input device config
PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-lcd/sw-keyboard.kl:system/usr/keylayout/sw-keyboard.kl \
	device/softwinner/bpi-m1plus-lcd/sun7i-ir.kl:system/usr/keylayout/sun7i-ir.kl \
	device/softwinner/bpi-m1plus-lcd/tp.idc:system/usr/idc/tp.idc 

#PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-lcd/initlogo.rle:root/initlogo.rle

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-lcd/vold.fstab:system/etc/vold.fstab
...
$(call inherit-product-if-exists, device/softwinner/bpi-m1plus-lcd/modules/modules.mk)

PRODUCT_CHARACTERISTICS := tablet

# Overrides
PRODUCT_BRAND  := BPI
PRODUCT_NAME   := bpi_m1plus_lcd
PRODUCT_DEVICE := bpi-m1plus-lcd
