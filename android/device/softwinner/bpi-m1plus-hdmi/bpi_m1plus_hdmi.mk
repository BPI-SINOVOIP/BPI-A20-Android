...
DEVICE_PACKAGE_OVERLAYS := device/softwinner/bpi-m1plus-hdmi/overlay

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-hdmi/modules/modules/nand.ko:root/nand.ko \
	device/softwinner/bpi-m1plus-hdmi/modules/modules/sun7i-ir.ko:root/sun7i-ir.ko 

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-hdmi/kernel:kernel \
	device/softwinner/bpi-m1plus-hdmi/recovery.fstab:recovery.fstab \
	frameworks/native/data/etc/android.hardware.wifi.xml:system/etc/permissions/android.hardware.wifi.xml \
	frameworks/base/data/etc/android.hardware.wifi.direct.xml:system/etc/permissions/android.hardware.wifi.direct.xml 

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-hdmi/ueventd.sun7i.rc:root/ueventd.sun7i.rc \
	device/softwinner/bpi-m1plus-hdmi/init.sun7i.rc:root/init.sun7i.rc \
	device/softwinner/bpi-m1plus-hdmi/init.sun7i.usb.rc:root/init.sun7i.usb.rc \
	device/softwinner/bpi-m1plus-hdmi/init.recovery.sun7i.rc:root/init.recovery.sun7i.rc \
	device/softwinner/bpi-m1plus-hdmi/camera.cfg:system/etc/camera.cfg \
	device/softwinner/bpi-m1plus-hdmi/media_profiles.xml:system/etc/media_profiles.xml \
	frameworks/native/data/etc/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml \
        frameworks/native/data/etc/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml

#input device config
PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-hdmi/sw-keyboard.kl:system/usr/keylayout/sw-keyboard.kl \
	device/softwinner/bpi-m1plus-hdmi/sun7i-ir.kl:system/usr/keylayout/sun7i-ir.kl \
	device/softwinner/bpi-m1plus-hdmi/tp.idc:system/usr/idc/tp.idc 

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-hdmi/initlogo.rle:root/initlogo.rle \
	device/softwinner/bpi-m1-hdmi/bootanimation.zip:system/media/bootanimation.zip

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m1plus-hdmi/vold.fstab:system/etc/vold.fstab
...
$(call inherit-product-if-exists, device/softwinner/bpi-m1plus-hdmi/modules/modules.mk)

PRODUCT_CHARACTERISTICS := tablet

# Overrides
PRODUCT_BRAND  := BPI
PRODUCT_NAME   := bpi_m1plus_hdmi
PRODUCT_DEVICE := bpi-m1plus-hdmi
