...
DEVICE_PACKAGE_OVERLAYS := device/softwinner/bpi-r1-hdmi/overlay

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-r1-hdmi/modules/modules/nand.ko:root/nand.ko \
	device/softwinner/bpi-r1-hdmi/modules/modules/sun7i-ir.ko:root/sun7i-ir.ko 

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-r1-hdmi/kernel:kernel \
	device/softwinner/bpi-r1-hdmi/recovery.fstab:recovery.fstab \
	frameworks/native/data/etc/android.hardware.wifi.xml:system/etc/permissions/android.hardware.wifi.xml \
	frameworks/base/data/etc/android.hardware.wifi.direct.xml:system/etc/permissions/android.hardware.wifi.direct.xml 

PRODUCT_COPY_FILES += \
	device/softwinner/bpi-r1-hdmi/ueventd.sun7i.rc:root/ueventd.sun7i.rc \
	device/softwinner/bpi-r1-hdmi/init.sun7i.rc:root/init.sun7i.rc \
	device/softwinner/bpi-r1-hdmi/init.sun7i.usb.rc:root/init.sun7i.usb.rc \
	device/softwinner/bpi-r1-hdmi/init.recovery.sun7i.rc:root/init.recovery.sun7i.rc \
	device/softwinner/bpi-r1-hdmi/camera.cfg:system/etc/camera.cfg \
	device/softwinner/bpi-r1-hdmi/media_profiles.xml:system/etc/media_profiles.xml \
	frameworks/native/data/etc/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml \
        frameworks/native/data/etc/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml

#input device config
PRODUCT_COPY_FILES += \
	device/softwinner/bpi-r1-hdmi/sw-keyboard.kl:system/usr/keylayout/sw-keyboard.kl \
...
$(call inherit-product-if-exists, device/softwinner/bpi-r1-hdmi/modules/modules.mk)

PRODUCT_CHARACTERISTICS := tablet

# Overrides
PRODUCT_BRAND  := BPI
PRODUCT_NAME   := bpi_r1_hdmi
PRODUCT_DEVICE := bpi-r1-hdmi
