...
public final class LatinIME extends InputMethodService implements KeyboardActionListener,
	...
	public boolean onKeyDown(int keyCode, KeyEvent event){
		...
		case KeyEvent.KEYCODE_DPAD_CENTER:
			...
			mPreKey = mLastKey;
			final MotionEvent me = MotionEvent.obtain(SystemClock.uptimeMillis(), SystemClock.uptimeMillis(), MotionEvent.ACTION_DOWN, mLastKey.mX, mLastKey.mY, 0);
			final MainKeyboardView tempInputView = mInputView;
			if (mPreKey != null && mPreKey.mCode == Keyboard.CODE_ACTION_ENTER) {
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        case KeyEvent.KEYCODE_DPAD_CENTER:
            ...
            final MotionEvent me = MotionEvent.obtain(SystemClock.uptimeMillis(), SystemClock.uptimeMillis(), MotionEvent.ACTION_UP, mLastKey.mX, mLastKey.mY, 0);
            final MainKeyboardView tempInputView = mInputView;
            if (mPreKey != null && mPreKey.mCode == Keyboard.CODE_ACTION_ENTER) {
                mHandler.postDelayed (new Runnable(){
                    public void run(){
