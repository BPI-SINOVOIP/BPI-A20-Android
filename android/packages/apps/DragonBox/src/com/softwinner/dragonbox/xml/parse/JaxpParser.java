...
package com.softwinner.dragonbox.xml.parse;
...
public class JaxpParser extends com.softwinner.dragonbox.xml.Parser
{
	...
	public com.softwinner.dragonbox.xml.Node parse(com.softwinner.dragonbox.xml.Node parentNode, org.w3c.dom.Node domNode, int rank)
	{
...
//		Debug.message("[" + rank + "] ELEM : " + domNodeName + ", " + domNodeValue + ", type = " + domNodeType + ", attrs = " + arrrsLen);
		...
		com.softwinner.dragonbox.xml.Node node = new com.softwinner.dragonbox.xml.Node();
	...
	public com.softwinner.dragonbox.xml.Node parse(com.softwinner.dragonbox.xml.Node parentNode, org.w3c.dom.Node domNode)
	{
	...
	{
		com.softwinner.dragonbox.xml.Node root = null;
