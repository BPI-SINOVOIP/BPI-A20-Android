...
#if defined RTL_8821AU_WIFI_USED
    /* rtl8821au usb wifi */
    #ifndef WIFI_DRIVER_MODULE_PATH
    #define WIFI_DRIVER_MODULE_PATH         "/system/vendor/modules/8821au.ko"
    #endif
    #ifndef WIFI_DRIVER_MODULE_NAME
    #define WIFI_DRIVER_MODULE_NAME         "8821au"
    #endif
...
int wifi_load_driver()
{
    ...
    if (strcmp(FIRMWARE_LOADER,"") == 0) {
		...
		do {
	        ...
	        if( 0 == fread(tmp_buf, sizeof(tmp_buf), 1, profs_entry) ){
	            ALOGD("faied to read proc/net/wireless");
	        }

		 ALOGD("read proc/net/wireless return %s", tmp_buf);
