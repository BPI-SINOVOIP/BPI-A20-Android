...
static const char *CACHE_LINK_PATH = "/cache/update.zip";
...
finish_recovery(const char *send_intent) {
    ...
    //Ensure cache only has one update.zip link.  
...
prepend_title(const char* const* headers) {
    const char* title[] = { "SDK : MID-A20-Android4.2-V2.1",
...
main(int argc, char **argv) {
    ...
    if (update_package!=NULL || update_package_ex!=NULL)
